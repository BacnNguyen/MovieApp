package gst.trainingcourse.movie.ui.fragment.category.movie.movieNowPlaying
...
@AndroidEntryPoint
class MovieNowPlayingFragment :
    BaseFragment<FragmentCategoryMovieBinding>(R.layout.fragment_category_movie) {

    private var isList = true

    private val viewModel by viewModels<MovieNowPlayingViewModel>()
    ...
    private fun onMovieClick(item: MovieResponse.Movie, position: Int) {
        val action = MovieNowPlayingFragmentDirections.actionMovieNowPlayingToMovieDetail(item.id)
